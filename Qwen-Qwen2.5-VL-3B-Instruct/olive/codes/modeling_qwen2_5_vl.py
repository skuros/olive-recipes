...
class Qwen2_5_VisionTransformerPretrainedModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(self, hidden_states: torch.Tensor, grid_thw: torch.Tensor, **kwargs) -> torch.Tensor:
        ...
        """
        # 1. Transpose to [-1, channels, temporal, patch_size, patch_size]
        #    Conv3D to get patch embeddings.
        # eg: hidden_states (input): [14308, 1176]
        # eg: hidden_states (output): [14308, 1280]
        hidden_states = self.patch_embed(hidden_states)
        # Calculate 2D rotary positional embeddings for each patch (14308 patches)
        # eg: grid_thw: [1, 3]
